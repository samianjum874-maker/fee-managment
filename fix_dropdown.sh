...
<head>
    ...
    <style>
        * {
        ...
        /* SIDEBAR - fixed, no overflow clipping */
        .sidebar {
            width: 280px;
            ...
            overflow: visible;   /* important: dropdown not clipped */
        }
        ...
        .dropdown-menu {
            position: absolute;
            bottom: 100%;          /* open upward by default (ooper) */
            left: 0;
            right: 0;
        ...
        /* Cards and other components (unchanged) */
    ...
    <script>
        ...
        function toggleSidebar() {
            ...
            if (isCollapsed) {
                ...
                // Close dropdown when collapsing to avoid ghost menu
        ...
        logoArea.addEventListener('click', toggleSidebar);
        ...
        // PROFILE DROPDOWN - dynamic positioning
        (function() {
            ...
            function positionDropdown() {
                ...
                if (isCollapsed) {
                    // collapsed: fixed position outside to the right
                    ...
                    if (rect.right + dropdownWidth + 8 > window.innerWidth) {
                        dropdown.style.left = (rect.left - dropdownWidth - 8) + 'px';
                    }
                    // vertical adjustment if off-screen
                    const dropdownHeight = dropdown.offsetHeight;
                    if (rect.top + dropdownHeight > window.innerHeight) {
                    ...
                    // expanded sidebar: open upward (above the button)
                    dropdown.style.position = 'absolute';
                    dropdown.style.left = '0';
                    dropdown.style.right = '0';
                    dropdown.style.bottom = '100%';   // upward
            ...
            profileBtn.addEventListener('click', function(e) {
                ...
                if (isVisible) {
                    ...
                    // need to wait for display:block to get dimensions
