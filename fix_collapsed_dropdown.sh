...
<body>
    ...
    <script>
        ...
        // PROFILE DROPDOWN - FIXED POSITIONING (collapsed mode opens to the right)
        (function() {
            ...
            function positionDropdown() {
                ...
                if (isCollapsed) {
                    // Collapsed sidebar: fixed position to the right of the button
                    ...
                    // Expanded sidebar: open upward, fallback to downward if space insufficient
            ...
            profileBtn.addEventListener('click', function(e) {
                ...
                if (isVisible) {
                    ...
                    // Wait for DOM to compute dimensions
